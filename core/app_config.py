...
ESP32_HTTP_URL = str(config_value("ESP32_HTTP_URL", "", ["LOCAL_ASSISTANT_ESP32_HTTP_URL", "ESP32_HTTP_URL"]))
ESP32_SERIAL_PORT = str(config_value("ESP32_SERIAL_PORT", "", ["LOCAL_ASSISTANT_ESP32_SERIAL_PORT", "ESP32_SERIAL_PORT"]))
ESP32_SERIAL_BAUD = int(config_value("ESP32_SERIAL_BAUD", "115200", ["LOCAL_ASSISTANT_ESP32_SERIAL_BAUD", "ESP32_SERIAL_BAUD"]))
